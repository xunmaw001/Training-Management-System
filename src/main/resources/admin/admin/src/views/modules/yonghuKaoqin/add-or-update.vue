               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考勤唯一编号" prop="yonghuKaoqinUuidNumber">
                       <el-input v-model="ruleForm.yonghuKaoqinUuidNumber"
                                 placeholder="考勤唯一编号" clearable  :readonly="ro.yonghuKaoqinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考勤标题" prop="yonghuKaoqinName">
                       <el-input v-model="ruleForm.yonghuKaoqinName"
                                 placeholder="考勤标题" clearable  :readonly="ro.yonghuKaoqinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学生考勤类型" prop="yonghuKaoqinTypes">
                        <el-select v-model="ruleForm.yonghuKaoqinTypes" :disabled="ro.yonghuKaoqinTypes" placeholder="请选择学生考勤类型">
                            <el-option
                                v-for="(item,index) in yonghuKaoqinTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yonghuKaoqinContent"  label="考勤详情" prop="yonghuKaoqinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yonghuKaoqinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yonghuKaoqinContent" label="考勤详情" prop="yonghuKaoqinContent">
                            <span v-html="ruleForm.yonghuKaoqinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    laoshiId: '',
                    yonghuKaoqinUuidNumber: new Date().getTime(),
                    yonghuKaoqinName: '',
                    yonghuKaoqinTypes: '',
                    yonghuKaoqinContent: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   yonghuKaoqinTypes: [
                              { required: true, message: '学生考勤类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_kaoqin_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuKaoqinTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yonghuKaoqinContent = _this.ruleForm.yonghuKaoqinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yonghuKaoqinContent = this.ruleForm.yonghuKaoqinContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yonghuKaoqin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yonghuKaoqinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
