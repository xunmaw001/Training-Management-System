        ...
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye'">
                    <el-form-item class="select" v-if="type!='info'"  label="实训模块" prop="zuoyeId">
                        <el-select v-model="ruleForm.zuoyeId" :disabled="ro.zuoyeId" filterable placeholder="请选择实训模块" @change="zuoyeChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实训模块名称" prop="zuoyeName">
                        <el-input v-model="zuoyeForm.zuoyeName"
                                  placeholder="实训模块名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实训模块编号" prop="zuoyeUuidNumber">
                        <el-input v-model="zuoyeForm.zuoyeUuidNumber"
                                  placeholder="实训模块编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实训模块地点" prop="zuoyeAddress">
                        <el-input v-model="zuoyeForm.zuoyeAddress"
                                  placeholder="实训模块地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="实训模块类型" prop="zuoyeValue">
                        <el-input v-model="zuoyeForm.zuoyeValue"
                                  placeholder="实训模块类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="内容" prop="zuoyeTijiaoText">
                        <el-input type="textarea"  :readonly="ro.zuoyeTijiaoText" v-model="ruleForm.zuoyeTijiaoText" placeholder="内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zuoyeShangchuanFile" label="作业上传" prop="zuoyeShangchuanFile">
                        <file-upload
                                tip="点击上传作业上传"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.zuoyeShangchuanFile" label="作业上传" prop="zuoyeShangchuanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.zuoyeShangchuanFile"  >作业上传下载</a>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zuoyeId: [
                              { required: true, message: '实训模块不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
