    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名唯一编号" prop="chengjiUuidNumber">
                       <el-input v-model="ruleForm.chengjiUuidNumber"
                                 placeholder="报名唯一编号" clearable  :readonly="ro.chengjiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名唯一编号" prop="chengjiUuidNumber">
                           <el-input v-model="ruleForm.chengjiUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实训模块" prop="chengjiKemu">
                       <el-input v-model="ruleForm.chengjiKemu"
                                 placeholder="实训模块" clearable  :readonly="ro.chengjiKemu"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实训模块" prop="chengjiKemu">
                           <el-input v-model="ruleForm.chengjiKemu"
                                     placeholder="实训模块" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分数" prop="chengjiPigai">
                       <el-input v-model="ruleForm.chengjiPigai"
                                 placeholder="分数" clearable  :readonly="ro.chengjiPigai"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="分数" prop="chengjiPigai">
                           <el-input v-model="ruleForm.chengjiPigai"
