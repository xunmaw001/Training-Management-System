...
var centerMenu = [
    ...
    {
        name: '考勤',
        url: '../yonghuKaoqin/list2.html'
    },
    {
        name: '学生考勤详情',
        url: '../yonghuKaoqinList/list.html'
    }
    ,{
        name: '实训成果',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shixunguanli/admin/dist/index.html#/login";
